...
3. Use `uv pip list` to see the list of installed packages and their versions.
4. Update the mimimum required versions in the `pyproject.toml` file to reflect the new versions.