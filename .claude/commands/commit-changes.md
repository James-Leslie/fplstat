...
1. Check the format and quality of the code using linters or formatters as needed.
1. Run tests to ensure nothing is broken.
1. Add and commit each changed file with a meaningful commit message that summarizes the changes made.
1. Push the committed changes to the remote repository.
1. Create a pull request if necessary, describing the changes and their purpose.
